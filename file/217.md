---
title: 适合新手最详细的jQuery插件开发教程
tags:
  - jQuery插件开发
id: 2601
categories:
  - web前端
date: 2017-04-16 11:32:43
---
...
![](http://images.cnitblog.com/blog/431064/201402/281858071314921.png)
...
&nbsp;
<pre></pre>
![](http://images.cnitblog.com/i/431064/201402/282326361905458.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858090417237.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858096414351.png)
...
<div class="highlight">
<pre>$.fn.myPlugin = function(options) {
    var defaults = {
        'color': 'red',
        'fontSize': '12px'
    };
...
![](http://images.cnitblog.com/blog/431064/201402/281858102422938.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858108955539.png)

### 保护好默认参数

注意到上面代码调用extend时会将defaults的值改变，这样不好，因为它作为插件因有的一些东西应该维持原样，另外就是如果你在后续代码中还要使用这些默认值的话，当你再次访问它时它已经被用户传进来的参数更改了。

![](http://images.cnitblog.com/blog/431064/201402/281858115012654.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858120772997.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858125256069.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858132263684.png)
...
![](http://images.cnitblog.com/blog/431064/201402/281858150896284.png)

2进入设置页面后点击'Webhooks &amp; Services '

![](http://images.cnitblog.com/blog/431064/201402/281858171145872.png)

3然后点击右边主页面上的'Configure services' 按钮

![](http://images.cnitblog.com/blog/431064/201402/281858178904272.png)

4这时出现一个很长的列表，向下找到jQuery Plugins 点击

![](http://images.cnitblog.com/blog/431064/201402/281858184199601.png)

5点击选中框后点击'更新设置'按钮

![](http://images.cnitblog.com/blog/431064/201402/281858199647873.png)
