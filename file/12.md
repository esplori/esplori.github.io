---
title: ajax 跳入error的一些原因
tags:
  - ajax
id: 2562
categories:
  - web前端
date: 2017-04-03 05:17:38
---
...
具体参数：
<pre>**XMLHttpRequest：XMLHttpRequest.readyState: 状态码的意思**
0 － （未初始化）还没有调用send()方法
1 － （载入）已调用send()方法，正在发送请求
2 － （载入完成）send()方法执行完成，已经接收到全部响应内容
3 － （交互）正在解析响应内容
4 － （完成）响应内容解析完成，可以在客户端调用了</pre>
<pre>**XMLHttpRequest：XMLHttpRequest.status:**</pre>
</div>